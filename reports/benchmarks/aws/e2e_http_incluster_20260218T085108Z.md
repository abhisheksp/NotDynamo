...
- Status: **FAIL**
- Timestamp (UTC): 2026-02-18T09:21:17Z
- Category: `in-cluster-job`
- Cluster: `notdynamo-eks`
- Region: `us-west-2`
- Namespace: `notdynamo`
- Base URL: `http://notdynamo-data.notdynamo.svc.cluster.local:8080`
- Job: `notdynamo-bench-http-20260218085116`

## Configuration

| Field | Value |
|---|---|
| Operations total (requested) | 48000 |
...
- JSON report: `reports/benchmarks/aws/e2e_http_incluster_20260218T085108Z.json`
- Run directory: `reports/benchmarks/aws/incluster_runs/notdynamo-bench-http-20260218085116`
- Job manifest: `reports/benchmarks/aws/incluster_runs/notdynamo-bench-http-20260218085116/job.yaml`
