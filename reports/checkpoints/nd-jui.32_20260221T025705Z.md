...
- Timestamp (UTC): `2026-02-21 02:57:05Z`
- Issue: `nd-jui.32`
- Claimed now: `1`
- Status override: `in_progress`
- Closed now: `0`
- Note: `Implemented control-plane write-load report ingestion and periodic hot-shard leader rebalance loop with move/churn safety caps and epoched map updates.`

## Issue Snapshot

```text
◐ nd-jui.32 · E53 Control-plane hot-shard leader rebalance   [● P1 · IN_PROGRESS]
