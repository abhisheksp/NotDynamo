...
- Timestamp (UTC): `2026-02-19 08:57:09Z`
- Issue: `nd-jui.14`
- Claimed now: `0`
- Status override: `none`
- Closed now: `1`
- Note: `Closed E35 as superseded by canonical isolated lockstep rerun in E43: reports/benchmarks/aws/e43_lockstep_isolated_fast_20260219T082041Z.{json,md,csv}.`

## Issue Snapshot

```text
✓ nd-jui.14 · E35 Single-AZ in-cluster lockstep sweep to 35   [● P2 · CLOSED]
...
[2026-02-19 08:57:09Z] Closed E35 as superseded by canonical isolated lockstep rerun in E43: reports/benchmarks/aws/e43_lockstep_isolated_fast_20260219T082041Z.{json,md,csv}.
...
5. [● P2] [task] nd-jui.19: E40 Reproducible benchmark runbook and report index
