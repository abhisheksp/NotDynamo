...
- Timestamp (UTC): `2026-02-21 02:56:56Z`
- Issue: `nd-jui.29`
- Claimed now: `1`
- Status override: `in_progress`
- Closed now: `0`
- Note: `Implemented two-level write admission in router (global + per-shard), new backpressure telemetry counters, and fast-fail UNAVAILABLE behavior with fairness tests.`

## Issue Snapshot

```text
◐ nd-jui.29 · E50 Two-level write admission (global + per-shard)   [● P1 · IN_PROGRESS]
