...
- Timestamp (UTC): `2026-02-19 08:56:53Z`
- Issue: `nd-jui.22`
- Claimed now: `0`
- Status override: `none`
- Closed now: `1`
- Note: `Completed isolated lockstep rerun for n=11,29,35 with RF=3 using benchmark-node pinning and prebuilt image reuse. Canonical artifacts: reports/benchmarks/aws/e43_lockstep_isolated_fast_20260219T082041Z.json/.md/.csv and per-point reports under reports/benchmarks/aws/e43_lockstep_isolated_fast_20260219T082041Z_runs. Outputs include TPS, p95/p99, error rate, telemetry attribution hint/CPU ratio, shard replicas per node, and estimated USD/hour; restore-on-exit returned cluster to desired nodegroup/data baseline.`

## Issue Snapshot

```text
✓ nd-jui.22 · E43 Lockstep rerun at n=11/29/35 on isolated benchmark infra   [● P1 · CLOSED]
...
DESCRIPTION
Execute high-node-count lockstep in-cluster sweeps with RF=3 using dedicated benchmark nodes, producing comparable reports across n=11, n=29, n=35.

NOTES
[2026-02-19 07:57:12Z] Start E43: run lockstep isolated in-cluster points n=11,29,35 with RF=3 and benchmark pods pinned to benchmark nodegroup, using prebuilt benchmark image reuse.
[2026-02-19 08:56:53Z] Completed isolated lockstep rerun for n=11,29,35 with RF=3 using benchmark-node pinning and prebuilt image reuse. Canonical artifacts: reports/benchmarks/aws/e43_lockstep_isolated_fast_20260219T082041Z.json/.md/.csv and per-point reports under reports/benchmarks/aws/e43_lockstep_isolated_fast_20260219T082041Z_runs. Outputs include TPS, p95/p99, error rate, telemetry attribution hint/CPU ratio, shard replicas per node, and estimated USD/hour; restore-on-exit returned cluster to desired nodegroup/data baseline.

ACCEPTANCE CRITERIA
Report bundle includes throughput, p50/p95/p99, error rate, pod placement, and cost context for all three points with benchmark jobs isolated from data nodes.

LABELS: benchmark, scaling, single-az

DEPENDS ON
  → ✓ nd-jui.21: E42 Benchmark saturation telemetry pack ● P1
