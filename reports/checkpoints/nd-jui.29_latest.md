...
- Timestamp (UTC): `2026-02-21 02:56:57Z`
- Issue: `nd-jui.29`
- Claimed now: `0`
- Status override: `none`
- Closed now: `1`
- Note: `Acceptance met: hot shard admission isolation, explicit backpressure counters, and router tests passing.`

## Issue Snapshot

```text
✓ nd-jui.29 · E50 Two-level write admission (global + per-shard)   [● P1 · CLOSED]
...
DESCRIPTION
Implement explicit fast-fail with node-global and per-shard admission limits for local leader write path.

NOTES
[2026-02-21 02:56:56Z] Implemented two-level write admission in router (global + per-shard), new backpressure telemetry counters, and fast-fail UNAVAILABLE behavior with fairness tests.
[2026-02-21 02:56:57Z] Acceptance met: hot shard admission isolation, explicit backpressure counters, and router tests passing.

ACCEPTANCE CRITERIA
Hot shards cannot starve node-wide writes; overload returns STATUS_CODE_UNAVAILABLE quickly; telemetry includes shard backpressure counters.
...
5. [● P1] [task] nd-jui.30: E51 Forward-path reduction via leader snapshot cache
6. [● P1] [task] nd-jui.31: E52 Per-shard consensus inflight pacing
7. [● P1] [task] nd-jui.32: E53 Control-plane hot-shard leader rebalance
8. [● P1] [task] nd-jui.33: E54 Horizontal write scaling sweep (single-AZ)
9. [● P1] [task] nd-jui.34: E55 Milestone closeout profile freeze
