...
- Timestamp (UTC): `2026-02-18 22:32:55Z`
- Issue: `nd-jui.20`
- Claimed now: `1`
- Status override: `in_progress`
- Closed now: `0`
- Note: `Start E41: dedicated benchmark nodegroup isolation and benchmark job scheduling controls`

## Issue Snapshot

```text
◐ nd-jui.20 · E41 Benchmark infrastructure isolation (dedicated nodegroup)   [● P1 · IN_PROGRESS]
