...
- Timestamp (UTC): `2026-02-18 07:13:35Z`
- Issue: `nd-jui.1`
- Claimed now: `0`
- Status override: `none`
- Closed now: `1`
- Note: `Acceptance met: nodes consume v2 partition metadata from control-plane and version update tests pass`

## Issue Snapshot

```text
✓ nd-jui.1 · E22 Shard Metadata v2 (per-shard group + replica set)   [● P1 · CLOSED]
...
[2026-02-18 07:13:35Z] Acceptance met: nodes consume v2 partition metadata from control-plane and version update tests pass
...
1. [● P1] [feature] nd-jui.2: E23 Multi-Raft runtime (one Raft group per shard)
...
?? reports/checkpoints/nd-jui.1_20260218T071335Z.md
