...
- Timestamp (UTC): `2026-02-18 22:48:18Z`
- Issue: `nd-jui.19`
- Claimed now: `0`
- Status override: `open`
- Closed now: `0`
- Note: `WIP normalization: moved back to open; report index/runbook work is partially complete and will be finalized after E42/E43 canonical benchmark artifacts are generated.`

## Issue Snapshot

```text
○ nd-jui.19 · E40 Reproducible benchmark runbook and report index   [● P2 · OPEN]
