...
- Timestamp (UTC): `2026-02-19 07:57:12Z`
- Issue: `nd-jui.22`
- Claimed now: `1`
- Status override: `in_progress`
- Closed now: `0`
- Note: `Start E43: run lockstep isolated in-cluster points n=11,29,35 with RF=3 and benchmark pods pinned to benchmark nodegroup, using prebuilt benchmark image reuse.`

## Issue Snapshot

```text
◐ nd-jui.22 · E43 Lockstep rerun at n=11/29/35 on isolated benchmark infra   [● P1 · IN_PROGRESS]
