...
- Timestamp (UTC): `2026-02-21 02:56:54Z`
- Issue: `nd-jui.28`
- Claimed now: `0`
- Status override: `none`
- Closed now: `1`
- Note: `Acceptance met via script validation and deterministic scorecard generation from benchmark JSON inputs.`

## Issue Snapshot

```text
✓ nd-jui.28 · E49 Measurement hardening for write gate   [● P1 · CLOSED]
...
DESCRIPTION
Standardize write-heavy benchmark profile and add deterministic analyzer output for bottleneck split + hotspot shards.

NOTES
[2026-02-21 02:56:53Z] Implemented deterministic write-gate analyzer and standardized gate runner scripts (analyze_write_gate.sh, eks_write_gate_run.sh) with canonical profile wiring and report outputs.
[2026-02-21 02:56:54Z] Acceptance met via script validation and deterministic scorecard generation from benchmark JSON inputs.

ACCEPTANCE CRITERIA
One command emits comparable scorecard (success_tps, timeout_fraction, forward_vs_consensus split, hotspot shards) from any run JSON.
...
5. [● P1] [task] nd-jui.29: E50 Two-level write admission (global + per-shard)
6. [● P1] [task] nd-jui.30: E51 Forward-path reduction via leader snapshot cache
7. [● P1] [task] nd-jui.31: E52 Per-shard consensus inflight pacing
8. [● P1] [task] nd-jui.32: E53 Control-plane hot-shard leader rebalance
9. [● P1] [task] nd-jui.33: E54 Horizontal write scaling sweep (single-AZ)
10. [● P1] [task] nd-jui.34: E55 Milestone closeout profile freeze
