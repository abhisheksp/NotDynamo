...
public final class RatisKvServiceHandler extends KvServiceGrpc.KvServiceImplBase {
    private final RatisKvRouter router;

    public RatisKvServiceHandler(RatisKvRouter router) {
