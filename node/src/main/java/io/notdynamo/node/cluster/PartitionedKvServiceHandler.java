...
public final class PartitionedKvServiceHandler extends KvServiceGrpc.KvServiceImplBase {
    private final PartitionedKvRouter router;

    public PartitionedKvServiceHandler(PartitionedKvRouter router) {
