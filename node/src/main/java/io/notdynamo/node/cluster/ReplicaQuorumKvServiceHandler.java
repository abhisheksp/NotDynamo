...
public final class ReplicaQuorumKvServiceHandler extends KvServiceGrpc.KvServiceImplBase {
    private final ReplicaQuorumKvRouter router;

    public ReplicaQuorumKvServiceHandler(ReplicaQuorumKvRouter router) {
